...
const jobSchema = new mongoose.Schema({
  ...
  description: {
    ...
    maxLength: [350, "Job title connot exceed 350 characters!"],
  },
  category: {
    type: String,
  ...
  fixedSalary: {
    ...
    maxLenth: [9, "Fixed salary cannot  exceed 9 digits!"],
  },
  salaryFrom: {
    type: Number,
    minLength: [4, "Salary from must contain at least 4 digits!"],
    maxLenth: [9, "Salary from cannot exceed 9 digits!"],
  },

  salaryTo: {
    type: Number,
    minLength: [4, "Salary from must contain at least 4 digits!"],
    maxLenth: [9, "SalaryTo cannot exceed 9 digits!"],
  },
  expired: {
    type: Boolean,
    default: false,
